...
public class QOTDBotLite {
    ...
    static final String version = "4.3.9";
    ...
    public static void main(String[] args) throws URISyntaxException {
        ...
        System.out.println("             = https://github.com/itsmarsss/QOTD-Bot-Lite =");
        System.out.println("             ==============================================");
        ...
        System.out.println();
        System.out.println("Note[1]: This bot is the Lite version of QOTD-Bot at [https://github.com/itsmarsss/QOTD-Bot]");
        System.out.println();
    ...
    static String versionCheck() {
        ...
        try {
            url = new URL("https://raw.githubusercontent.com/itsmarsss/QOTD-Bot-Lite/main/newestversion");
            URLConnection uc;
        ...
        if (!newest.equals(version)) {
            return "   [There is a newer version of QOTD Bot Lite]" +
                    ...
                    "\nNew version: https://github.com/itsmarsss/QOTD-Bot-Lite/releases" +
                    "\n\t##############################################" +
                    "\n" + note;
        }
        return " This program is up to date!" +
                "\n" + note +
                "\n[https://github.com/itsmarsss/QOTD-Bot-Lite/releases]";
    }
